...
type SearchPipelineStep interface {
	GetIndex() int
	GetName() string
	Search(ctx context.Context, accountIds []uuid.UUID, query string, metadataType *entity.MetadataType, sortKey entity.ElasticSortKey, size int) ([]*entity.ElasticImageMetaData, entity.ElasticSortKey, error)
}
